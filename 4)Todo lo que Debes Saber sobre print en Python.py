...
# Por ejemplo, si tienes un código que no funciona como esperabas, puedes agregar print() para revisar el valor de las variables antes de que el problema ocurra. Esto te ayuda a entender qué está pasando en tu código en tiempo real, y detectar posibles fallos o comportamientos inesperados.
...
# Es lo mismo  solo que inverti las variables.
print(f"autor: {author}, frase: {frase}")
